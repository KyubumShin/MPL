...
const server = new Server({ name: 'mpl-server', version: '4.1.0' }, { capabilities: { tools: {} } });
// Register tools
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
        case 'mpl_score_ambiguity':
            return handleScoreAmbiguity(args);
        case 'mpl_state_read':
            return handleStateRead(args);
        case 'mpl_state_write':
            return handleStateWrite(args);
        default:
            return {
