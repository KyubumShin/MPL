...
export async function handleScoreAmbiguity(args) {
    ...
    const clarity = scores.spec_completeness.score * WEIGHTS.spec_completeness +
    ...
    let weakestDim = 'spec_completeness';
...
function generateQuestion(dimension, justification) {
    const templates = {
